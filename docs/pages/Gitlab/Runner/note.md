http://www.javashuo.com/article/p-xpjhcasl-kh.html
...
<img src="images/21.png" alt="images" style="zoom:200%;" />
...
docker run -itd --rm -v ~/data/gitlab-runner/config:/etc/gitlab-runner  gitlab/gitlab-runner:v12.6.0 register \
  --non-interactive \
  --executor "shell" \
  --url "http://42.192.12.240/" \
  --registration-token "MhuxrCWtVfQSDGdMW5Qw" \
  --description "devops-runner" \
  --tag-list "build,deploy" \
  --run-untagged="true" \
  --locked="false" \
